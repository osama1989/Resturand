   ...
   <div class="position_content" id="page_position_content">
    <div class="clearfix colelem" id="pu891"><!-- group -->
     <div class="clip_frame grpelem" id="u891"><!-- image -->
      <img class="block" id="u891_img" src="images/cold%20drinks.png" alt="" width="233" height="234"/>
     </div>
    ...
    <div class="colelem" id="accordionu898wrapper"><!-- vertical box -->
     ...
     {	          
       ...
       <div class="AccordionPanelTab clearfix colelem" id="u900-4"><!-- content -->
        <p> <span class="name"> <?php     echo $row['name'] ;    ?> </span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="price"> <?php     echo $row['price']; ?></span> SP  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
       </div>
 ...
 jQuery(document).ready(function($){
	var Arrays=new Array();
     ...
     if  ( $.totalStorage('items') !== null)
        ...
        {
         $('#left_bar .cart-info').append('<div class="shopp" id="each-'+myArray[i]['id']+'"><div class="label">'+myArray[i]['name']+'</div><div class="shopp-price"> $<em>'+(myArray[i]['price'])*(myArray[i]['zip'])+'</em></div><span class="shopp-quantity">'+myArray[i]['zip']+'</span><img src="remove.png" class="remove" /><br class="all" /></div>');
